...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    temperature = 323.0
    initial_mean_irradiation_cluster_defect_size = 0.0 #4.0e-6
    inital_irradiation_cluster_defect_density = 0.0 #5.0e13
    initial_irradiation_SIA_loop_density = 8.15e10 #Bring down to same order of magnitude as Pritam seemed to use
...
[Executioner]
  ...
  [./TimeStepper]
    type = FunctionDT
    time_dt = '1e-3 1e-3  1e-4   1e-5  1e-5'
    time_t  = '0    3.0   5.0    7.0   10.0'
  [../]
