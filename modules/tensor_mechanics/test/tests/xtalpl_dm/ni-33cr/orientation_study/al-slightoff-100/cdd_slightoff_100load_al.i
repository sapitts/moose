#Ni single crystal, loaded in the orientation [1,0,0](0,1,1) (Goss orientation)
...
[Materials]
  [./elasticity_tensor]
    ...
    C_ijkl = '108.2e3 61.3e3 61.3e3 108.2e3 61.3e3 108.2e3 28.5e3 28.5e3 28.5e3' #Hirth and Lothe for Al, 2nd ed, pg 835
    fill_method = symmetric9
    euler_angle_1 = 0.4
    euler_angle_2 = 45.0
    euler_angle_3 = 0.9063
  [../]
  [./stress]
