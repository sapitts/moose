...
[Materials]
  ...
  [./trial_xtalpl]
    ...
    temperature = 298.0
    initial_immobile_dislocation_density = 1.5e7 #1.5e7 initial dislocation density in Blaizot et.al. 2016;
    initial_mobile_dislocation_density = 1.5e7 #1.5e7 initial dislocation density in Blaizot et.al. 2016;
    Baily_Hirsch_barrier_coefficient = 0.4
    dislocation_self_hardening_parameter = 1
    dislocation_latent_hardening_parameter = 1.0
    Peierls_stress = 7.277 #1.0e-4 times shear modulus
