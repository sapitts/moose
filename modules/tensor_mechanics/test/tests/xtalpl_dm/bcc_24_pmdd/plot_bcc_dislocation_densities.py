...
pmdd_all_irr_file = 'pmdd_crystal_plasticity_3bar48load_singleElem_temp'
...
pyplot.savefig('slip_system_strength_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('tau_slip_system_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('slip_increment_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
ax1.set_ylabel('2nd Piola Kirchoff Stress in Z-direction (MPa)')
ax1.set_xlabel('Lagrangian  Strain in Z-direction (mm/mm)')
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('stress-strain_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('mobile_dislocations_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('mobile_dislocations_bcc_3bar48load_stochastic_singleElem_active_systems_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('immobile_dislocations_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('immobile_dislocations_bcc_3bar48load_stochastic_singleElem_active_systems_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('xslip_dislocations_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('xslip_dislocations_bcc_3bar48load_stochastic_singleElem_active_systems_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
# ax1= pyplot.subplot(111)
#
# p1 = ax1.plot(xvalue[0], yvalue[0]**2.0*3.0/2.0, color='steelblue', label='Scalar SIA loop density')
#
# #ax1.legend(loc='lower right', numpoints = 1, prop={'size':10})
# #ax1.set_xlim([0,0.0035])
# #ax1.set_ylim([0,900])
...
# pyplot.subplots_adjust(left=0.12)
# pyplot.subplots_adjust(right=0.88)
# pyplot.savefig('sia_loop_evolution_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
#
# # Close all of the open figures
# pyplot.close()
#
...
# fig_number = 1 + fig_number
# columns = []
# columns.append('contact_sia_loop_0')
# columns.append('contact_sia_loop_1')
# columns.append('contact_sia_loop_2')
# columns.append('contact_sia_loop_3')
# columns.append('contact_sia_loop_4')
# columns.append('contact_sia_loop_5')
# columns.append('contact_sia_loop_6')
# columns.append('contact_sia_loop_7')
# columns.append('contact_sia_loop_8')
# columns.append('contact_sia_loop_9')
# columns.append('contact_sia_loop_10')
# columns.append('contact_sia_loop_11')
# columns.append('contact_sia_loop_12')
# columns.append('contact_sia_loop_13')
# columns.append('contact_sia_loop_14')
# columns.append('contact_sia_loop_15')
# columns.append('contact_sia_loop_16')
# columns.append('contact_sia_loop_17')
# columns.append('contact_sia_loop_18')
# columns.append('contact_sia_loop_19')
# columns.append('contact_sia_loop_20')
# columns.append('contact_sia_loop_21')
# columns.append('contact_sia_loop_22')
# columns.append('contact_sia_loop_23')
# print "Data collected: " + ' '.join(columns)
#
# #set a figure number integer for the plots to make sure we get a clean figure for each new plot
# fig_number = 1
...
# #ax1.set_xlim([0,0.0035])
#
# ax1.set_ylabel('Component of Slip System Resistance from SIA Loop Density(MPa)')
# ax1.set_xlabel('Lagrangian  Strain in X-direction (mm/mm)')
# ax1.set_title('Contribution of SIA Loops to Slip System Resistance')
#
# ax1.yaxis.tick_left()
# ax1.tick_params(labeltop='off')
# #ax1.errorbar(x2,y2, yerr=2)
...
# pyplot.subplots_adjust(right=0.88)
#
# pyplot.savefig('sia_loop_resistance_bcc_3bar48load_stochastic_singleElem_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
#
# # Clear the figure of the current plot to make room for a new plot
# pyplot.clf()
