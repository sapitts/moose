...
[Materials]
  ...
  [./trial_xtalpl]
    ...
    dislocation_dynamic_recovery_coefficient = 15
    dislocation_multiplication_coefficient = 0.32
    dislocation_barrier_strength_parameter = 0.006
    initial_immobile_dislocation_density = 5e+07
    initial_mobile_dislocation_density = 4e+07
    neutron_irradiation_dose = 0.0
