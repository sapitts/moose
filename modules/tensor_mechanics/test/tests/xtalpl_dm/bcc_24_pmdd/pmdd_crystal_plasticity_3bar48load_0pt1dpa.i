...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    initial_irradiation_SIA_loop_density = 12.3e11 # for 0.1% Cu from Lambrecht et al. (2010)
    irradiation_SIA_loop_hexagonal_diameter = 1.5e-6 #Diameter is multipled by 3 to find the size
