...
[Problem]
  restart_file_base = bixtal_parallel_521_nognd_checkpoint_cp/LATEST
[]
...
[Materials]
  ...
  [./trial_xtalpl]
    ...
    alpha_5 = 0.001
    alpha_6 = 0.1
    include_GND_contribution = false #true
...
[Executioner]
  ...
  dtmax = 1.0e-6
  dtmin = 1.0e-8
  dt = 1.0e-6 #might try with 5e-6 to get more speed
  end_time = 10 #is the final time
