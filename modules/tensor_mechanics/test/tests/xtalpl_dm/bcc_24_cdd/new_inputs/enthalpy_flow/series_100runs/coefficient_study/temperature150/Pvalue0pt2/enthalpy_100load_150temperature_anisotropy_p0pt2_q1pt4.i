...
[Materials]
  ...
  [../]
  [./trial_xtalpl]
    type = CrystalPlasticityCDDEnthalpyVelocityBCCFeUpdate
    ...
    alpha_5 = 0.015
    alpha_6 = 1.0
    initial_thermal_slip_system_resistance = 15.0 #Peierls_stress = 15.0 #Alpha-iron is 11MPa
    flow_rule_exponent_p = 0.2 #0.28
    flow_rule_exponent_q = 1.4 #1.34
