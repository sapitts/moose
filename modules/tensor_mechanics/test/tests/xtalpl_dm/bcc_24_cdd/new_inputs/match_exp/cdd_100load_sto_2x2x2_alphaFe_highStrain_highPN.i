...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    temperature = 323.0
    initial_immobile_dislocation_density = 1.0e6
    initial_mobile_dislocation_density = 1.0e6
...
#    inital_irradiation_cluster_defect_density = 0.0 #5.0e13
    ...
    Peierls_stress = 90.0 #Alpha-iron is 11MPa, #90 is from Barton et al (2014)
