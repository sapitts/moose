...
#    C_ijkl = '274.7e3 117.7e3 117.7e3 274.7e3 117.7e3 274.7e3 78.49e3 78.49e3 78.49e3' #Values for 323K, 9Cr-1Mo
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    temperature = 323.0
    initial_immobile_dislocation_density = 3.5e7 #Lambrecht(2008) pure Fe, equally divided
    initial_mobile_dislocation_density = 3.5e7 #Lambrecht(2008) pure Fe, equally divided
#    initial_mean_irradiation_cluster_defect_size = 0.0 #34.0e-6
#    inital_irradiation_cluster_defect_density = 0.0 #5.0e13
    initial_irradiation_SIA_loop_density = 12.7e11 #Primatims paper referencing Lambrecht 2010
    irradiation_SIA_loop_size = 7.0e-6 #Pritam's paper that references Lambrecht 2010
