...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    temperature = 323.0
    initial_immobile_dislocation_density = 3.0e7 #Lambrecht(2008) pure Fe
    initial_mobile_dislocation_density = 4.0e7 #Lambrecht(2008) pure Fe
#    initial_mean_irradiation_cluster_defect_size = 0.0 #34.0e-6
#    inital_irradiation_cluster_defect_density = 0.0 #5.0e13
    initial_irradiation_SIA_loop_density = 12.7e11 #Lambrecht 2008
    irradiation_SIA_loop_size = 7.0e-6 #Lambrecht 2008
    irradiation_SIA_loop_hardening_coefficient = 0.7 #Lambrecht 2008 via Pritam's paper
