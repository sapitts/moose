...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    temperature = 323.0
    initial_immobile_dislocation_density = 4.5e7 #Lambrecht(2008) Fe-0.1%Cu
    initial_mobile_dislocation_density = 4.5e7 #Lambrecht(2008) Fe-0.1%Cu
    neutron_irradiation_dose = 0.1 #Lambrecht 2008, match to David Bai's cluster dynamics data
