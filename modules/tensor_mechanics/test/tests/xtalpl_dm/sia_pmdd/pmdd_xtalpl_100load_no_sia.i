...
[AuxKernels]
  ...
  [./scalar_damage_loops]
    type = RankTwoScalarAux
    variable = scalar_damage_loops
    rank_two_tensor = irradiation_SIA_loop_damage_tensor
    scalar_type = VonMisesStress
  [../]
  #[./rot_out_001]
...
[Materials]
  [./elasticity_tensor]
    ...
    C_ijkl = '242.0e3 150.0e3 150.0e3 242.0e3 150.0e3 242.0e3 112.0e3 112.0e3 112.0e3' #Values from Li et.al 2014
...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
    ...
    #euler_angle_1 =  64.9127 for 3bar48
    #euler_angle_2 = 110.556
    #euler_angle_3 = 270.0
  [../]
  [./strain]
  ...
  [./trial_xtalpl]
    ...
    temperature = 323.0
    shear_modulus = 80.0e3 #78489
    thermal_slip_system_resistance = 11.0  #Alpha iron peiels stress is 11 MPa
    ...
    cross_slip_factor = 8000
    neutron_irradiation_dose = 0.0 #0.1
    initial_irradiation_SIA_loop_density = 0.0 #8.15e11 #from parameter study in Pritam's 2016 paper
    irradiation_SIA_loop_hexagonal_diameter = 8.267e-6 #Diameter is multipled by 3 to find the size
