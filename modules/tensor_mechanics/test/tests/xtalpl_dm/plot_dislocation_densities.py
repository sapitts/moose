...
pmdd_no_irr_file = 'pmdd_crystal_plasticity_noIrr'
pmdd_sia_irr_file = 'pmdd_crystal_plasticity_onlySIA'
pmdd_cluster_irr_file = 'pmdd_crystal_plasticity_onlyClusters'
pmdd_all_irr_file = 'pmdd_crystal_plasticity'

# Generate the names of the postprocessor csv output files
pmdd_all_irr_csv_file = [pmdd_all_irr_file, '_out.csv']
pmdd_sia_csv_file = [pmdd_sia_irr_file, '_out.csv']
pmdd_cluster_csv_file = [pmdd_cluster_irr_file, '_out.csv']
pmdd_no_irr_csv_file = [pmdd_no_irr_file, '_out.csv']

pmdd_all_output_file = ''.join(pmdd_all_irr_csv_file)
pmdd_sia_output_file = ''.join(pmdd_sia_csv_file)
pmdd_cluster_output_file = ''.join(pmdd_cluster_csv_file)
pmdd_no_output_file = ''.join(pmdd_no_irr_csv_file)


# Build the array of csv files to read the selected data
files = []
files.append(pmdd_all_output_file)
files.append(pmdd_sia_output_file)
files.append(pmdd_cluster_output_file)
files.append(pmdd_no_output_file)

print "Gathering values from these files: " + ' and '.join(files)

#headers of the columns which we want to plot
columns = []
columns.append('gss_27')
...
p1 = ax1.plot(xvalue[0], yvalue[0], color='maroon', marker='+', label='SIA Loops and Cluster Defects, (12-3)[111]')
p2 = ax1.plot(xvalue[1], yvalue[1], color='deepskyblue', label='Only SIA Loop Defects, (12-3)[111]')
p3 = ax1.plot(xvalue[2], yvalue[2], color='darkgoldenrod', marker='+', label='Only Cluster Defects, (12-3)[111]')
p4 = ax1.plot(xvalue[3], yvalue[3], color='darkgreen', label='Unirradiated, (12-3)[111]')
p1 = ax1.plot(xvalue[4], yvalue[4], color='maroon', linestyle='--', label='SIA Loops and Cluster Defects, (011)[11-1]')
p2 = ax1.plot(xvalue[5], yvalue[5], color='deepskyblue', linestyle=':', label='Only SIA Loop Defects, (011)[11-1]')
p3 = ax1.plot(xvalue[6], yvalue[6], color='darkgoldenrod', linestyle='--', label='Only Cluster Defects, (011)[11-1]')
p4 = ax1.plot(xvalue[7], yvalue[7], color='darkgreen', linestyle=':', label='Unirradiated, (011)[11-1]')
...
ax1.set_title('Slip System Strength Among Irradiation Defect Types')
...
pyplot.savefig('slip_system_strength_Irr_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
#headers of the columns which we want to plot
columns = []
columns.append('slip_increment_27')
...
ax1.set_title('Slip Increment Among Irradiation Defect Types')
...
pyplot.savefig('slip_increment_Irr_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
p1 = ax1.plot(xvalue[0], yvalue[0], color='maroon', marker='+', label='SIA Loops and Cluster Defects')
p2 = ax1.plot(xvalue[1], yvalue[1], color='deepskyblue', label='Only SIA Loop Defects')
p3 = ax1.plot(xvalue[2], yvalue[2], color='darkgoldenrod', marker='+', label='Only Cluster Defects')
p4 = ax1.plot(xvalue[3], yvalue[3], color='darkgreen', label='Unirradiated')
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('stress-strain_Irr_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
ax1.legend(loc='upper left', numpoints = 1, prop={'size':10})
ax1.set_xlim([0,0.025])
#ax1.set_ylim([1.5e7,5.0e7])

ax1.set_ylabel('Mobile Dislocation Density (1/mm^2)')
ax1.set_xlabel('Lagrangian  Strain (mm/mm)')
ax1.set_title('Mobile Dislocation Evolution with Varying Defects')
ax1.yaxis.tick_left()
ax1.tick_params(labeltop='off')
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('mobile_dislocations_Irr_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
fig_number = 1 + fig_number
columns = []
columns.append('immobile_disl_27')
...
ax1.set_xlabel('Lagrangian  Strain (mm/mm)')
ax1.set_title('Immobile Dislocation Evolution with Varying Defects')
ax1.yaxis.tick_left()
ax1.tick_params(labeltop='off')
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('immobile_dislocations_Irr_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
