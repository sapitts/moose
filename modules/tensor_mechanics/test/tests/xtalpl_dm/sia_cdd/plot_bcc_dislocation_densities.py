...
pmdd_all_irr_file = 'cdd_xtalpl_100load_815e12_temp'
...
pyplot.savefig('slip_system_strength_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('tau_slip_system_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('slip_increment_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
p1 = ax1.plot(xvalue[0], yvalue[0], color='teal', marker='+', label='Single BCC crystal')
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('stress-strain_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
fig_number = 1 + fig_number
columns = []
columns.append('vonmises_stress')
print "Data collected: " + ' '.join(columns)
...
for i in xrange(len(columns)):
  for j in xrange(len(files)):
    print j+len(files)*i
    xvalue[j+len(files)*i], yvalue[j+len(files)*i] = readTimeSeries(files[j], 'effective_strain', columns[i])
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('effective-stress-strain_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('mobile_dislocations_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('mobile_dislocations_bcc_100load_deterministic_815e12_active_systems_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('immobile_dislocations_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('immobile_dislocations_bcc_100load_deterministic_815e12_active_systems_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('xslip_dislocations_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.savefig('xslip_dislocations_bcc_100load_deterministic_815e12_active_systems_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('sia_loop_evolution_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
...
pyplot.subplots_adjust(left=0.12)
pyplot.subplots_adjust(right=0.88)
pyplot.savefig('sia_loop_resistance_bcc_100load_deterministic_815e12_comparison.pdf',bbox_inches='tight',pad_inches=0.1)
