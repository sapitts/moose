...
[AuxKernels]
  ...
  [./sia_loop_resistance]
    type = MaterialRealAux
    variable = sia_loop_resistance
    property = irradiation_SIA_loop_slip_resistance_component
  [../]
  [./gss_0]
...
#    C_ijkl = '279.06e3 119.6e3 119.6e3 279.06e3 119.6e3 279.06e3 79.731e3 79.731e3 79.731e3'  #Values for 273K
  ...
  [./trial_xtalpl]
    ...
    initial_irradiation_SIA_loop_density = 0.0 #8.15e11 #Bring down to same order of magnitude as Pritam seemed to use
    irradiation_SIA_loop_size = 24.8e-6 #from Pritam's 2016 paper to match the DD
