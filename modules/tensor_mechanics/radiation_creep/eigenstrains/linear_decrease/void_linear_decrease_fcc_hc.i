...
[Materials]
  ...
  [void_density]
    ...
    expression = 'if(temperature<611.0, 2.387e13,
                    if(temperature<=835.0, 2.387e13 *(1.0 - (temperature - 611.0) / 1344.0), 0.0))' #1/mm^3, gives an eigenstrain of 1.0e-5 with radius=1.0e-6mm
    # outputs = exodus
  []
[]
