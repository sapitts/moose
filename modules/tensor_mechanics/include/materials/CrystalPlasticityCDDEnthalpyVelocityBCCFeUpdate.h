...
#ifndef CRYSTALPLASTICITYCDDENTHALPYVELOCITYBCCFEUPDATE_H
#define CRYSTALPLASTICITYCDDENTHALPYVELOCITYBCCFEUPDATE_H

#include "CrystalPlasticityCDDEnthalpyVelocityUpdateBase.h"

class CrystalPlasticityCDDEnthalpyVelocityBCCFeUpdate;

template<>
InputParameters validParams<CrystalPlasticityCDDEnthalpyVelocityBCCFeUpdate>();

/**
 * CrystalPlasticityCDDEnthalpyVelocityBCCFeUpdate uses the multiplicative decomposition of deformation gradient
...
class CrystalPlasticityCDDEnthalpyVelocityBCCFeUpdate : public CrystalPlasticityCDDEnthalpyVelocityUpdateBase

{
public:
  CrystalPlasticityCDDEnthalpyVelocityBCCFeUpdate(const InputParameters & parameters);
...
#endif //CRYSTALPLASTICITYCDDENTHALPYVELOCITYBCCFEUPDATE_H
