...
[Mesh]
  file = 'bicrystal_5micron_gauge_pinned_pts.e'
[]
...
[BCs]
  [fixed_y]
    type = DirichletBC
    variable = disp_y
    boundary = 'bottom_surface top_surface'
    value = 0
  []
  [fixed_x]
    type = DirichletBC
...
[Executioner]
  ...
  dtmax = 10.0
  # num_steps = 10
  end_time = 250.0 # time to reach 25% strain with 5micron gauge length
[]
