...
#include "CrystalPlasticityCDDBCCFeUpdate.h"
#include "libmesh/utility.h"

registerMooseObject("TensorMechanicsApp", CrystalPlasticityCDDBCCFeUpdate);
...
CrystalPlasticityCDDBCCFeUpdate::CrystalPlasticityCDDBCCFeUpdate(const InputParameters & parameters) :
...
void
CrystalPlasticityCDDBCCFeUpdate::initQpStatefulProperties()
{
...
void
CrystalPlasticityCDDBCCFeUpdate::setInitialConstitutiveVariableValues()
{
...
void
CrystalPlasticityCDDBCCFeUpdate::updateConstitutiveSlipSystemResistanceAndVariables(bool & error_tolerance)
{
...
bool
CrystalPlasticityCDDBCCFeUpdate::areConstitutiveStateVariablesConverged()
{
  bool density_and_resistance_not_converged = CrystalPlasticityCDDUpdateBase::areConstitutiveStateVariablesConverged();
...
void
CrystalPlasticityCDDBCCFeUpdate::calculateSlipSystemResistance(bool & error_tolerance)
{
  ...
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
    _slip_system_resistance[_qp][i] = forest_strength[i] +
...
void
CrystalPlasticityCDDBCCFeUpdate::initSlipSystemResistance()
{
  for (unsigned int i = 0; i < _number_slip_systems; ++i)
...
void
CrystalPlasticityCDDBCCFeUpdate::applyAnisotropicStrengthFactor()
{
...
Real
CrystalPlasticityCDDBCCFeUpdate::calculateClusterDefectHardening()
{
...
Real
CrystalPlasticityCDDBCCFeUpdate::calculateSIALoopHardening()
{
...
void
CrystalPlasticityCDDBCCFeUpdate::calculateIradiationSIALoopDensity()
{
