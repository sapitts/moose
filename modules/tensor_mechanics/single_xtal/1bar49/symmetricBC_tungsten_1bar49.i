...
[Modules/TensorMechanics/Master]
  [all]
    ...
    incremental = true
    add_variables = true
    generate_output = 'stress_zz stress_xx stress_yy'
  []
[]
...
[Materials]
  ...
  []
  [trial_xtalpl]
    type = CrystalPlasticityContinuumDislocationDynamicsUpdate
    ...
    initial_immobile_dislocation_density = 2.75e3 #from Brunner 2010  #4.5e8 # roughly David's measurement # 1.0e7 was from Srivastava et al (2013) specified mobile
    initial_mobile_dislocation_density = 2.75e3 #from Brunner 2010  #4.5e8 # roughly David's measurement # 1.0e7 from Srivastava et al (2013), assumed equal to mobile
    ...
    shear_modulus = 160.0e3 # Assumed same as C44 value from elasticity tensor
    stol = 1.0e-3
    print_state_variable_convergence_error_messages = true
  []
[]
