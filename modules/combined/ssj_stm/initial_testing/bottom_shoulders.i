...
lr_dist = '${fparse -1.0 *(lower_right_radius - (lower_right_radius * (1.0/(sqrt(2.0)))))}'
...
[Mesh]
  [bottom_shoulder]
    ...
    top_type = CIRCARC
    right_type = LINE
    left_parameter = '${shoulder_tab_curvature}'
    top_parameter = '${lr_dist}'
    bottom_parameter = '${ll_dist}'
  []
[]
