...
upper_left_radius = 1.49235
upper_right_radius = 1.33958
lower_left_radius = 1.38595
lower_right_radius = 1.23208
gauge_width = 1.20341
gauge_height = 5.91585
# min 5.446, max 5.954
...
#  arc midpoints
lr_midpt_x = '${fparse lr_radius_corner_x + lower_right_radius * (cos(-3.0 * pi / 4.0)) }'
lr_midpt_y = '${fparse lower_gauge_y + lower_right_radius * (sin(-3.0 * pi / 4.0))}'
...
#  arc midpoints
ur_midpt_x = '${fparse ur_radius_corner_x + upper_right_radius * (cos(3.0 * pi / 4.0)) }'
ur_midpt_y = '${fparse upper_gauge_y + upper_right_radius * (sin(3.0 * pi / 4.0))}'
