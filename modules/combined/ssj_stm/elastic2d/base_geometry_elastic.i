...
[Modules/TensorMechanics/Master]
  [all]
    ...
    incremental = true
    add_variables = true
    generate_output = 'stress_xy stress_zz stress_xx stress_yy strain_xx strain_yy strain_xy vonmises_stress'
    # additional_material_output_family = FIRST
