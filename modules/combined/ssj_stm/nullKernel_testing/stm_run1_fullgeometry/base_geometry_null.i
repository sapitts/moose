...
upper_left_radius = 1.2261376491634 #1.4
upper_right_radius = 1.3944132820757 #1.4
lower_left_radius = 1.3559719966827 #1.4
lower_right_radius = 1.4813736266388 #1.4
gauge_width = 1.1847358109229 #1.2
gauge_height = 5.8130462078263 #5.7
# min 5.446, max 5.954
...
#  arc midpoints
lr_midpt_x = '${fparse lr_radius_corner_x - lower_right_radius * (cos(pi / 4.0))}' #
lr_midpt_y = '${fparse lower_gauge_y - lower_right_radius * (sin(pi / 4.0))}' #
ll_midpt_x = '${fparse ll_radius_corner_x + lower_left_radius * (cos(pi/4.0))}' #
ll_midpt_y = '${fparse lower_gauge_y - lower_left_radius * (sin(pi/4.0))}' #
...
## arc midpoints
ur_midpt_x = '${fparse ur_radius_corner_x - upper_right_radius * (cos(pi / 4.0))}' #
ur_midpt_y = '${fparse upper_gauge_y + upper_right_radius * (sin(pi / 4.0))}' #
ul_midpt_x = '${fparse ul_radius_corner_x +upper_left_radius * (cos(pi / 4.0))}'
ul_midpt_y = '${fparse upper_gauge_y + upper_left_radius * (sin(pi / 4.0))}'
