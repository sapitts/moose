...
[Functions]
  ...
  # [k_effective_avg]
  #   type = ParsedFunction
  #   expression = '(avg * area) / (temp_diff  * height)'
  #   symbol_names = 'avg area temp_diff height'
  #   symbol_values = 'bottom_flux area_bottom temperature_diff cylinder_height'
  # []
  [k_effective_int]
    type = ParsedFunction
  ...
  [k_effective_top]
    ...
    expression = '(-flux * height) / temp_diff'
    symbol_names = 'flux temp_diff height'
    symbol_values = 'top_flux temperature_diff cylinder_height'
  []
[]
