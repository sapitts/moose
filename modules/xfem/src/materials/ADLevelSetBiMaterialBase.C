...
ADLevelSetBiMaterialBase<compute_stage>::ADLevelSetBiMaterialBase(const InputParameters & parameters)
...
template <ComputeStage compute_stage>
void
ADLevelSetBiMaterialBase<compute_stage>::computeProperties()
{
  ...
  ADMaterial<compute_stage>::computeProperties();
}

template <ComputeStage compute_stage>
void
ADLevelSetBiMaterialBase<compute_stage>::computeQpProperties()
{
...
adBaseClass(ADLevelSetBiMaterialBase);
