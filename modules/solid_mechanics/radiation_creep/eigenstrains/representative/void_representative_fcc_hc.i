...
[Materials]
  ...
  [void_density]
    ...
    expression = 'if(temperature<611.0, 1.0e7, if(temperature>835.0, 1.0e7, -478315529 * (temperature - 723.0)^2.0 + 6.0e12) )'
    # outputs = exodus
  []
  [void_radius]
    type = ParsedMaterial
    ...
    coupled_variables = temperature
    # expression = 1.0
    expression = 'if(temperature<611.0, 2.0e-07, (-3.0e-11 * temperature^2 + 6.0e-8 * temperature - 2.52e-5))'
  []
[]
