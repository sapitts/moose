...
upper_left_tab_width = '${fparse upper_left_radius + gauge_width/2.0}'
upper_right_tab_width = '${fparse upper_right_radius + gauge_width/2.0}'
lower_left_tab_width = '${fparse lower_left_radius + gauge_width/2.0}'
lower_right_tab_width = '${fparse lower_right_radius + gauge_width/2.0}'
...
lower_left_tab_height = '${fparse base_tab_height - lower_left_radius}'
lower_right_tab_height = '${fparse base_tab_height - lower_right_radius}'
